const inventario = { // Objeto con la lista de productos
    productos: [ // Arreglo de productos
        { 
            ...
            Almacenamiento: 128, 
            Precio: 300, 
            imagen: "./Recursos/Imagenes/iPhone_11.png" // Ruta relativa (fotos locales)
        },
        { 
            nombre: "iPhone 11 Pro", 
            Almacenamiento: 128, 
            Precio: 380, 
            imagen: "./Recursos/Imagenes/iPhone_11Pro.png" // Ruta relativa (fotos locales)
        },
        { 
            nombre: "iPhone 12", 
            Almacenamiento: 128, 
            Precio: 390, 
            imagen: "./Recursos/Imagenes/iPhone_12.png" // Ruta relativa (fotos locales)
        },
        { 
            nombre: "iPhone 12 Pro ", 
            Almacenamiento: 128, 
            Precio: 430, 
            imagen: "./Recursos/Imagenes/iPhone_12Pro.png" // Ruta relativa (fotos locales)
        },
        { 
            nombre: "iPhone 13", 
            Almacenamiento: 128, 
            Precio: 500, 
            imagen: "./Recursos/Imagenes/iPhone_13.webp" // Ruta relativa (fotos locales)
        },
        { 
            nombre: "iPhone 13 Pro", 
            Almacenamiento: 128, 
            Precio: 600, 
            imagen: "./Recursos/Imagenes/iPhone_13Pro.png" // Ruta relativa (fotos locales)
        },
        { 
            nombre: "iPhone 14 ", 
            Almacenamiento: 128, 
            Precio: 570, 
            imagen: "./Recursos/Imagenes/iPhone_14.png" // Ruta relativa (fotos locales)
        },
        { 
            nombre: "iPhone 14 Pro ", 
            Almacenamiento: 128, 
            Precio: 780, 
            imagen: "./Recursos/Imagenes/iPhone_14Pro.png" // Ruta relativa (fotos locales)
        },
        { 
            nombre: "iPhone 15 ", 
            Almacenamiento: 128, 
            Precio: 800, 
            imagen: "./Recursos/Imagenes/iPhone_15.webp" // Ruta relativa (fotos locales)
        },
        { 
            nombre: "iPhone 15 Pro", 
            Almacenamiento: 128, 
            Precio: 970, 
            imagen: "./Recursos/Imagenes/iPhone_15Pro.png" // Ruta relativa (fotos locales)
        },
        { 
            nombre: "iPhone 16", 
            Almacenamiento: 128, 
            Precio: 1000, 
            imagen: "./Recursos/Imagenes/iPhone_16.png" // Ruta relativa (fotos locales)
        },
        { 
            nombre: "iPhone 16 Pro", 
            Almacenamiento: 128, 
            Precio: 1280, 
            imagen: "./Recursos/Imagenes/iPhone_16Pro.png" // Ruta relativa (fotos locales)
        },
        { 
